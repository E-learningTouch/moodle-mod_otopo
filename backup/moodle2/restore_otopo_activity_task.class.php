...
class restore_otopo_activity_task extends restore_activity_task {
    ...
    public static function define_restore_log_rules() {
        ...
        $rules[] = new restore_log_rule('otopo', 'update', 'view.php?id={course_module}', '{otopo}');
        $rules[] = new restore_log_rule('otopo', 'view', 'view.php?id={course_module}', '{otopo}');
        $rules[] = new restore_log_rule('otopo', 'choose', 'view.php?id={course_module}', '{otopo}');
        $rules[] = new restore_log_rule('otopo', 'choose again', 'view.php?id={course_module}', '{otopo}');
