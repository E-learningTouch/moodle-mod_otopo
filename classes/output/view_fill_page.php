...
class view_fill_page implements renderable, templatable
{
     ...
     * @param integer|null $sessionid            Session ID.
     * @param integer|null $sessionindex         Session index.
     * @param boolean      $sessionvalid         Session is valid?
     * @param boolean      $sessionvalidorclosed Session is valid or closed?
    ...
    public function export_for_template(renderer_base $output)
    {
        ...
        $data->displayname          = $data->otopo->session && $data->session ? $data->session->name : get_string('fillautoeval', 'otopo', $data->sessionindex);
